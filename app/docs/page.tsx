...
export default function DocsPage() {
  return (
    <article className="prose-invert mx-auto max-w-2xl space-y-6">
      <h1 className="font-display text-3xl font-bold md:text-4xl">How Sweep works</h1>
      ...
      <section className="space-y-2">
        ...
        <p className="text-fog">
          At create time we set pump.fun fee shares to 80% collection sweep wallet / 20% Sweep
          protocol, then revoke admin so it cannot change. You remain the on-chain creator. Sweep
      ...
      <Button href="/launch">Launch on Sweep</Button>
    </article>
  );
}
